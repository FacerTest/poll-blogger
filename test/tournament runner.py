# Howdy!
# If you're trying to improve my code, I am so sorry :( 
                            ...
                            case "n":
                                while True:
                                    try:
                                        ...
                                        tempCounter = 2*(int(input("Which poll should the thing start posting at? (1 is the first poll of this set)"))-1)
                                        break
                                    except ValueError:
                                        print("Uh oh!")
                                while True:
                                    try:
                                        finalCompetitorPosted = 2*(int(input("Which poll should be the LAST one posted? ("+str(currentRoundCompetitorQuantity/2)+" is the last poll of this set)"))-1)
